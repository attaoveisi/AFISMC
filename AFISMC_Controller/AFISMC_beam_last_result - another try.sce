...
[X,R,Lh,eps1,eps2,eps3,eps4,eps5,eps6,eps7,eps8,eps9,eps10,gama]= XLIST(:)
...
Init_guess=list(X0,R0,Lh0,eps1_0,eps2_0,eps3_0,eps4_0,eps5_0,eps6_0,eps7_0,eps8_0,eps9_0,eps10_0,gama_0);
...
save('controller_observer_gain.dat',K0,L0);
